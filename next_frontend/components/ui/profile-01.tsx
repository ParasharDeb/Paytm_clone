        ...
        <div className="relative px-6 pt-12 pb-6">
          <div className="flex items-center gap-4 mb-8">
            <div className="relative shrink-0">
              <div className="w-[72px] h-[72px] bg-zinc-100 dark:bg-zinc-800 rounded-full ring-4 ring-white dark:ring-zinc-900 flex items-center justify-center">
                <span className="text-xl font-semibold text-zinc-900 dark:text-zinc-100">{getInitials(name)}</span>
              </div>
